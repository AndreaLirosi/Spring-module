...
public class Ciao {
    ...
    public User greet (@RequestParam(value = "name")String name,
                       @RequestParam(value = "province", required = false, defaultValue = "Lombardia")String province,
                       @RequestParam(value = "saluto", required = false, defaultValue = "Ciao %s, com'è il tempo in %s") String greeting)
